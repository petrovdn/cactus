...
class App extends Component {
	...
	constructor(props) {
		...
		this.state = {
			basic: true,
			listViewData: Array(20).fill('').map((_,i)=>`Заявка №${i}`)
		};
	}
				...
				<View style={styles.standalone}>
					...
					>
						<View style={styles.standaloneRowBack}>
							<Text style={styles.backTextWhite}>Левое</Text>
							<Text style={styles.backTextWhite}>Правое</Text>
						</View>
						<View style={styles.standaloneRowFront}>
							<Text>Эт. неподвижный элемент</Text>
						</View>
					</SwipeRow>
				</View>
